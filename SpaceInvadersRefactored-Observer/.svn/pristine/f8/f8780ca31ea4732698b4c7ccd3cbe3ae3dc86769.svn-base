...
public class SIGame {
	...
	// CS 210: Observer Lecture/Lab: Need a console writer to be an observer
	...
	public SIGame() {
		...
		// CS 210: Observer Lecture/Lab: Make the observer object
	...
	private void invade() {
		if (RND.nextInt(250) < 1) {
			...
			// CS 210: Observer Lecture/Lab: Add the console writer as an observer to each Invader created
			i.addObserver(cw);
			sprites.add(i);
		}
	}
