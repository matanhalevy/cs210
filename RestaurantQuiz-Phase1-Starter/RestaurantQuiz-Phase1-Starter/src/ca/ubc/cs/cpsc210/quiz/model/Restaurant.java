...
public class Restaurant {
    ...
    public Restaurant ( List<Category> categories,String address, String postalCode, String name, String id, GeoArea geographicalArea){
    ...
    return (name + ", " + geographicalArea.getCity + ", " + postalCode);
    }
}