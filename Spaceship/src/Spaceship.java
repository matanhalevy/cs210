 ...
 * at (0, 0) and bottom-right corner at (600, 600)
 * 
...
public class Spaceship {
	...
	/**
	 * Construct a new spaceship object and place it inside the rectangle at (250, 250)
	 */
	public Spaceship(int x, int y) {
		this.x = 250; // This statement sets the x field of the object to the value 250
		this.y = 250; // This statement sets the y field of the object to the value 250
	}
